...
Zu den Eckdaten, welche in einer tabellarischen Übersicht zur Verfügung gestellt werden können, gehören unter anderem Angaben zur Version, zu den Entwicklern und der Lizenz. Dies ermöglicht z. B. eine schnelle Übersicht darüber, ob die begutachtete Software mit der eigenen technischen Umgebung kompatibel ist. Einen Vorschlag zu den Inhalte einer solchen Tabelle haben wir an den Ende dieses Beitrags gesetzt. Details zu allen Einträgen  dort werden ausführlicher im vorhergehenden Text behandelt.
